...
class FirstPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: StockColor.white,
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(Icons.reorder, color: StockColor.black),
          ),
        ],
      ),
      body: Container(
        padding: EdgeInsets.symmetric(vertical: 8, horizontal: 16),
        color: StockColor.grey1,
        child: ListView(
          children: [
            Container(
